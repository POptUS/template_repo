...
def main():
    ...
    DESCRIPTION = "Return status of mytemplate python package full testing " \
    ...
    pkg = importlib.metadata.distribution("mytemplate")
    location = Path(inspect.getfile(mytemplate)).parents[0]
    ...
    # ----- RUN FULL TEST SUITE
    return _SUCCESS if mytemplate.test(verbosity_level) else _FAILURE
